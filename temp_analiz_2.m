%% Sıcaklık kontrolü bulunan temiz oda
clear
z1=now;
link='Pulsed\deney3\';
Tlog=importdata('Pulsed\deney3\t\sicaklik.txt');
...
exportgraphics(gcf,'MaxLine2.png','Resolution',Res)
%% Sıcamlık ve Max
close
subplot(1,2,1)
yyaxis left
...
set(gca, 'YMinorTick','on', 'XMinorTick','on')
set(gca, 'YMinorGrid','on', 'XMinorGrid','on')
% exportgraphics(gcf,'TvsY2Max_2.png','Resolution',Res)
% %% integral hesabı
% close
subplot(1,2,2)
...
grid on
set(gcf,'position',[25.8,343,1116,420])
exportgraphics(gcf,'TvsYint_2.png','Resolution',Res)
%% geçen zaman
z2=(now-z1)*(3600*24);
